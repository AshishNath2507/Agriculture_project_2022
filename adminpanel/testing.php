...
<a href="#deleteEmployeeModal" class="delete deletebtn" data-toggle="modal"><?php echo $row["slno"]; ?></a>
<a href="delete.php?slno=<?php echo $row["slno"]; ?> " class="delete deletebtn"></a>